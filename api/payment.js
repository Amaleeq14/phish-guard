...
module.exports = async function handler(req, res) {
  ...
  if (action === 'initiate') {
    ...
    const { contactCount, platforms, customerEmail, customerName, customerPhone, paymentOption } = req.body;
    ...
    const payload = {
      ...
      payment_options: (() => {
        const optMap = {
          card:        'card',
          ussd:        'ussd,mobilemoney',
          banktransfer:'banktransfer,account',
          barter:      'barter',
        };
        return optMap[paymentOption] || 'card,ussd,mobilemoney,banktransfer,barter,account';
      })(),
    };
